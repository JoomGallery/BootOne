        ...
        <div class="qq-uploader-selector qq-uploader span12">
          ...
          <ul class="qq-upload-list-selector qq-upload-list">
            <li class="alert alert-success">
              ...
              <?php if($this->editFilename) echo '<input class="qq-edit-filename-selector qq-edit-filename form-control" tabindex="0" type="text">'; ?>
              <span class="qq-upload-size-selector qq-upload-size badge"></span>
              <a class="qq-upload-cancel-selector qq-upload-cancel btn btn-default btn-mini" href="#"><?php echo JText::_('COM_JOOMGALLERY_COMMON_CANCEL', true); ?></a>
...
<form action="<?php echo JRoute::_('index.php'); ?>" method="post" name="AjaxUploadForm" id="AjaxUploadForm" enctype="multipart/form-data" class="form-validate form-horizontal" onsubmit="">
  <div class="form-group">
    <?php echo preg_replace('/class="/', 'class="control-label col-md-2 ', $this->ajax_form->getLabel('catid'), 1); ?>
    <div class="col-md-4">
      <?php echo str_replace('class="', 'class="form-control ', $this->ajax_form->getInput('catid')); ?>
    </div>
  </div>
      <?php if(!$this->_config->get('jg_useruseorigfilename')): ?>
  <div class="form-group">
    <?php echo preg_replace('/class="/', 'class="control-label col-md-2 ', $this->ajax_form->getLabel('generictitle'), 1); ?>
    <div class="col-md-4">
      <div class="checkbox">
        <label><?php echo $this->ajax_form->getInput('generictitle'); ?></label>
      </div>
    </div>
  </div>
  <div class="form-group">
    <?php echo preg_replace('/class="/', 'class="control-label col-md-2 ', $this->ajax_form->getLabel('imgtitle'), 1); ?>
    <div class="col-md-4">
      <?php echo str_replace('class="', 'class="form-control ', $this->ajax_form->getInput('imgtitle')); ?>
    </div>
  </div>
      <?php endif;
            if(!$this->_config->get('jg_useruseorigfilename') && $this->_config->get('jg_useruploadnumber')): ?>
  <div class="form-group">
    <?php echo preg_replace('/class="/', 'class="control-label col-md-2 ', $this->ajax_form->getLabel('filecounter')); ?>
    <div class="col-md-4">
      <?php echo str_replace('class="', 'class="form-control ', $this->ajax_form->getInput('filecounter')); ?>
    </div>
  </div>
      <?php endif; ?>
  <div class="form-group">
    <?php echo preg_replace('/class="/', 'class="control-label col-md-2 ', $this->ajax_form->getLabel('imgtext')); ?>
    <div class="col-md-4">
      <?php echo str_replace('class="', 'class="form-control ', $this->ajax_form->getInput('imgtext')); ?>
    </div>
  </div>
  <div class="form-group">
    <?php echo preg_replace('/class="/', 'class="control-label col-md-2 ', $this->ajax_form->getLabel('imgauthor')); ?>
    <div class="col-md-4">
      <div class="jg-uploader form-control-static"><?php echo JHtml::_('joomgallery.displayname', $this->_user->get('id'), 'upload'); ?></div>
    </div>
  </div>
  <div class="form-group">
    <?php echo preg_replace('/class="/', 'class="control-label col-md-2 ', $this->ajax_form->getLabel('published')); ?>
    <div class="col-md-4">
      <?php echo str_replace('class="', 'class="form-control ', $this->ajax_form->getInput('published')); ?>
    </div>
  </div>
      <?php if($this->_config->get('jg_delete_original_user') == 2): ?>
  <div class="form-group">
    <?php echo preg_replace('/class="/', 'class="control-label col-md-2 ', $this->ajax_form->getLabel('original_delete')); ?>
    <div class="col-md-4">
      <?php echo str_replace('class="', 'class="form-control ', $this->ajax_form->getInput('original_delete')); ?>
    </div>
  </div>
      <?php endif;
            if($this->_config->get('jg_special_gif_upload') == 1): ?>
  <div class="form-group">
    <?php echo preg_replace('/class="/', 'class="control-label col-md-2 ', $this->ajax_form->getLabel('create_special_gif')); ?>
    <div class="col-md-4">
      <?php echo str_replace('class="', 'class="form-control ', $this->ajax_form->getInput('create_special_gif')); ?>
    </div>
  </div>
      <?php endif;
            if($this->_config->get('jg_redirect_after_upload')): ?>
  <div class="form-group">
    <?php echo preg_replace('/class="/', 'class="control-label col-md-2 ', $this->ajax_form->getLabel('debug')); ?>
    <div class="col-md-4">
      <?php echo str_replace('class="', 'class="form-control ', $this->ajax_form->getInput('debug')); ?>
    </div>
  </div>
      <?php endif; ?>
  <div class="form-group">
